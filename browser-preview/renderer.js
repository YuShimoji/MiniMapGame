...
// Phase C decorations are retained as generated map detail.
...
const DECORATION_STYLES = {
  StreetLight: { color: '#888888', shape: 'circle', baseSize: 1.5 },
  ...
  Bollard:     { color: '#666666', shape: 'square', baseSize: 1.0 },
...
function renderDecorations(ctx, decorations, tx, ty, ts) {
  for (const dec of decorations) {
    ...
    ctx.strokeStyle = darkenHex(style.color, 0.2);
    ctx.lineWidth = 0.5;
